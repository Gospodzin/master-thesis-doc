...
\pagebreak Punkt $ p $, który jest bezpośrednio gęstościowo osiągalny z innego \mbox{punktu $ q $}, ale sam nie jest punktem rdzeniowym, jest nazywany \textit{punktem brzegowym} ($ edge_{D,\varepsilon,\mu}(p) $).
