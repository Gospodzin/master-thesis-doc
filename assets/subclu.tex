...
Z \myhyperref{eq:d-vs-d-projected}{wyrażenia} wynika jeszcze jedna ważna własność, którą SUBCLU wykorzystuje do ograniczenia zbioru danych podczas grupowania w podprzestrzeniach. Zbiór $ V $ może być zbiorem gęstościowo łącznym w podprzestrzeni $ S $, tylko jeśli $ V $ jest podzbiorem zbioru gęstościowo łącznego $ W $ w $ T $.
\begin{equation}
